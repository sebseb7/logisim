...
public class hex2sevensegHDLGeneratorFactory extends AbstractHDLGeneratorFactory{
	...
	public ArrayList<String> GetModuleFunctionality(Netlist TheNetlist,
		...
		Contents.add("   ");
		Contents.add("   MakeSegs : PROCESS( Hexin )");
		Contents.add("   BEGIN");
		Contents.add("      CASE (Hexin) IS");
	...
	public SortedMap<String, String> GetPortMap(Netlist Nets,
		...
		PortMap.putAll(GetNetMap("Hexin",true,ComponentInfo,hex2sevenseg.Hexin,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_a",true,ComponentInfo,hex2sevenseg.Segment_A,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_b",true,ComponentInfo,hex2sevenseg.Segment_B,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_c",true,ComponentInfo,hex2sevenseg.Segment_C,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_d",true,ComponentInfo,hex2sevenseg.Segment_D,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_e",true,ComponentInfo,hex2sevenseg.Segment_E,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_f",true,ComponentInfo,hex2sevenseg.Segment_F,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_g",true,ComponentInfo,hex2sevenseg.Segment_G,Reporter,HDLType,Nets));
		return PortMap;
	}
