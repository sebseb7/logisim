...
public class ReptarLocalBusHDLGeneratorFactory
  ...
  public ArrayList<String> GetComponentInstantiation(Netlist TheNetlist,
      AttributeSet attrs, String ComponentName, String HDLType /* boolean hasLB */) {
    ArrayList<String> Contents = new ArrayList<String>();
    ...
    Contents.add("             Addr_LB_o                 : OUT std_logic_vector( 7 DOWNTO 0 );");
    ...
    Contents.add("          FPGA_in             : IN std_logic_vector(11 downto 0);");
