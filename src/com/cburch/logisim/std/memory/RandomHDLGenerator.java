...
public class RandomHDLGenerator  extends HDLGenerator {
  ...
  public RandomHDLGenerator(HDLCTX ctx) {
    ...
    parameters.add(new ParameterInfo("Seed", seed));
    inPorts.add(new PortInfo("Clear", 1, Random.RST, false));
    inPorts.add(new PortInfo("Enable", 1, Random.NXT, true));
    outPorts.add(new PortInfo("Q", "BitWidth", Random.OUT, null));
    clockPort = new ClockPortInfo("GlobalClock", "ClockEnable", Random.CK);
    
    wires.add(new WireInfo("s_InitSeed", 48));
    wires.add(new WireInfo("s_reset", 1));
    wires.add(new WireInfo("s_reset_next", 3));
    wires.add(new WireInfo("s_mult_shift_next", 36));
    wires.add(new WireInfo("s_seed_shift_next", 48));
    wires.add(new WireInfo("s_mult_busy", 1));
    wires.add(new WireInfo("s_start", 1));
    wires.add(new WireInfo("s_mac_lo_in_1", 25));
    wires.add(new WireInfo("s_mac_lo_in_2", 25));
    wires.add(new WireInfo("s_mac_hi_1_next", 24));
    wires.add(new WireInfo("s_mac_hi_in_2", 24));
    wires.add(new WireInfo("s_busy_pipe_next", 2));
