...
public class XmlAttributesUtil {
  static void addAttributeSetContent(Document doc, String outFilepath,
      Element elt, AttributeSet attrs, AttributeDefaultProvider source) {
    if (attrs == null)
      return;
