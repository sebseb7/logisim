// The following code is adapted from Open JDK 10 WeakHashMap to provide
// identity-based comparison. Other than changes needed to move this code out of
// the standard library, the only changes were:
// Replace: key.hashCode()
//    with: System.identityHashCode(key)
// Replace: key.equals(key2)
//    with: key == key2
// Original source code from:
//    http://hg.openjdk.java.net/jdk10/jdk10/jdk/file/777356696811/src
/*
...
public class WeakIdentityHashMap<K,V>
    ...
    final int hash(Object k) {
        int h = System.identityHashCode(k); // k.hashCode();
    ...
    private static class Entry<K,V> extends WeakReference<Object> implements Map.Entry<K,V> {
        ...
        public int hashCode() {
            K k = getKey();
            V v = getValue();
            return System.identityHashCode(k) ^ Objects.hashCode(v); // Objects.hashCode(k) ^ Objects.hashCode(v);
        }
