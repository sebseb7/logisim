...
class SimulationToolbarModel extends AbstractToolbarModel
  ...
  public void stateChanged(ChangeEvent e) {
    ...
    simEnable.setToolTip(running
        ? S.getter("simulateDisableStepsTip") : S.getter("simulateEnableStepsTip"));
    tickEnable.setIcon(ticking ? "simtstop.png" : "simtplay.png");
    tickEnable.setToolTip(ticking
        ? S.getter("simulateDisableTicksTip") : S.getter("simulateEnableTicksTip"));
