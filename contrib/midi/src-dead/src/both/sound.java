...
public class sound extends InstanceFactory{
	...
	public void propagate(InstanceState state) {
		...
		try
			{
			mArgs[0]=new Integer(0);
			/* equivalent to: Value valnote = state.getPort(0); */
			Value valnote = (Value)(mGetPort.invoke(state,mArgs));
			mArgs[0]=new Integer(1);
			Value valvelocity = (Value)(mGetPort.invoke(state,mArgs));
			mArgs[0]=new Integer(2);
			Value valonoff = (Value)(mGetPort.invoke(state,mArgs));
			mArgs[0]=new Integer(3);
			Value valchan = (Value)(mGetPort.invoke(state,mArgs));
			mArgs[0]=new Integer(4);
			Value valinst = (Value)(mGetPort.invoke(state,mArgs));
