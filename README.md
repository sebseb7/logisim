...
* [Java JAR file](http://mathcs.holycross.edu/~kwalsh/logisim-evolution-2.13.18hc.jar) (platform independent)
* [Windows EXE file](http://mathcs.holycross.edu/~kwalsh/logisim-evolution-2.13.18hc.exe) (windows only)
* [Mac Disk Image](http://mathcs.holycross.edu/~kwalsh/logisim-evolution-2.13.18hc.dmg) (mac only)

To run the JAR file, open a command line (or Mac Terminal or Windows CMD.exe
prompt) and type `java -jar logisim-evolution-2.13.18hc.jar` from within the
